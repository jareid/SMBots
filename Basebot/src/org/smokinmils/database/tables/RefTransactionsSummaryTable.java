...
* @author Jamie
*/
public final class RefTransactionsSummaryTable {
    /**
     * Hiding the default constructor.
     */
    private RefTransactionsSummaryTable() { }

	/** Table name. */
	public static final String NAME = "referral_transactions_summary";
	...
	public static final String COL_FROMID = "from_user";
