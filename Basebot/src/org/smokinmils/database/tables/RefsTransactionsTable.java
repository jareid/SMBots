...
* @author Jamie
*/
public final class RefsTransactionsTable {
    /**
     * Hiding the default constructor.
     */
    private RefsTransactionsTable() { }

	/** Table name. */
	public static final String NAME = "referral_transactions";
    ...
    /** Column for the userid. */
    public static final String COL_FROMUSERID = "from_user";
