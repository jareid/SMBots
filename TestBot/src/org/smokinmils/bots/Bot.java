...
public class Bot {
    public static void main(String[] args) throws Exception {
    	...
    	basebot.addListener(swift_irc, new DiceDuel(swift_bot, "#testeroo"), oudd_swift_chans);
    	...
    	bet_timer.scheduleAtFixedRate( new BetDetails( basebot.getBot(swift_irc), "#testeroo" ), 5*60*1000, 60*60*1000);
    	
    	Timer comp_timer = new Timer(true);
    	comp_timer.scheduleAtFixedRate( new Competition( basebot.getBot(swift_irc), "#testeroo" ), 60*1000, 60*1000);
    	
    	Timer jkpt_timer = new Timer(true);
    	jkpt_timer.scheduleAtFixedRate( new JackpotAnnounce( basebot.getBot(swift_irc), "#testeroo" ), 2*60*1000, 60*60*1000);
