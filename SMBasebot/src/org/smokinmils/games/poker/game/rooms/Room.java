...
import org.smokinmils.games.poker.game.events.*;
...
public class Room extends Thread {
     ...
     */
	public Room( Channel channel, Client irc, RoomType rt ) {
	 ...
	 * @return
	 */
	public Channel getChannel() { return IrcChannel; }
	...
	protected void setTopic(String in) {		
		...
		RoomTopic = in;
		IrcClient.getBot().setTopic( IrcChannel, RoomTopic );
	}
}
