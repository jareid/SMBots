...
/**
 * Interface to represent an irc game that will be called from the BOT
 * different games can all be run independently :)
 * @author cjc
 */
public interface IRCGame {
	 ...
	 * @param command	The command to process in the form of a list of strings (0 is command etc)
	 * @param username	The username of the person
	 * @return			The strings to send back to the channel
	 */
	public List<String> processCommand(String[] command, User user, int userlevel, PircBotX bot);
	 ...
	 * @param taskId	The task which to perform
	 */
	public List<String> timerTask(int taskId);
	
	/**
	 * Returns an HashMap<Integer,Integer> that will denote all tasks that this has to do
